      ...
      <div class="d-modal" @click.stop>
        <div class="d-modal-hd">
          ...
          <div>
            ...
            <div class="d-modal-sub">PDF lastes ned og Outlook åpnes</div>
          </div>
        ...
        <label class="d-field" style="margin-bottom:12px">
          ...
          <input class="d-inp d-inp-full" type="email" v-model="epost" placeholder="kunde@eksempel.no">
        </label>
        ...
        <div class="d-modal-preview">
          ...
          <div class="d-modal-row"><span>Blindkopi:</span><span style="font-family:var(--mono);font-size:12px">support@zewo.no</span></div>
        ...
        <div v-if="sentOk" class="d-modal-ok">✅ Outlook åpnes – husk å dra inn PDF-en fra Downloads.</div>
        <div v-else-if="sendError" class="d-modal-err">⚠ {{ sendError }}</div>
        <div v-else class="d-modal-tip">📎 PDF lastes ned automatisk – legg den ved i Outlook før du sender.</div>

        <div class="d-modal-footer">
          <button class="d-m-cancel" @click="showMail = false">Avbryt</button>
          <button class="d-m-confirm" :disabled="!epost" @click="sendMail">📤 Åpne Outlook</button>
        </div>
      </div>
    </div>
  </Teleport>
